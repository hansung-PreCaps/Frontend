_xamzrequire = function() {
    ...
    70: [ function(require, module, exports) {
        (function(process) {
            (function() {
                var warning = [ "The AWS SDK for JavaScript (v2) is in maintenance mode.", " SDK releases are limited to address critical bug fixes and security issues only.\n", "Please migrate your code to use AWS SDK for JavaScript (v3).", "For more information, check the blog post at https://a.co/cUPnyil" ].join("\n");
                module.exports = {
                    suppress: false
                };
...
}, {}, [ 33 ]);AWS.apiLoader.services["cognitoidentity"] = {};
...
AWS.LexRuntime = AWS.Service.defineService("lexruntime", [ "2016-11-28" ]);AWS.apiLoader.services["lexruntime"]["2016-11-28"] = {
    version: "2.0",
    metadata: {
